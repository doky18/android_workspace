...
public class MainActivity extends AppCompatActivity {
    ...
    public void openMap() {
        //액티비티는 시스템이 관리하므로 액티비티를 화면에서 교체하려면
        //개발자는 시스템에 부탁을 해야하는데 이때 어떤 의도를 갖는 지에 대한 정보객체인
        //intent를 이용해야한다.. (의도+정보보관)
        Intent intent = new Intent(this, MymapActivity.class);  //mymap을 화면에~
